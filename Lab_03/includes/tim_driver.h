 ...
 * @return TIM_OK or TIM_ERROR.
 */
TIM_Status_t tim_pwm_config(TIM_TypeDef *tim, TIM_Channel_t channel,TIM_PWM_Mode_t mode);
 ...
 */
TIM_Status_t tim_set_ccr(TIM_TypeDef *tim, TIM_Channel_t channel,uint32_t value);
